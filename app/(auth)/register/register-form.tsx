      ...
      <Card className="w-full max-w-md border-border/60 bg-card shadow-xl text-center">
        <CardContent className="pt-10 pb-8 px-8">
          ...
          <p className="text-xs text-muted-foreground">
            ...
            <button className="text-primary hover:underline" onClick={() => setConfirmedEmail(null)}>
              try again
            </button>
            .
          </p>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input id="email" type="email" placeholder="you@example.com" autoComplete="email" className="pl-9" {...register('email')} />
            </div>
