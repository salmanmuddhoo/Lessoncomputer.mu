...
export const metadata = { title: 'Add Revision Notes' }

export default async function NewRevisionNotesPage() {
  ...
  return (
    <div>
      <div className="mb-8">
        <h1 className="text-2xl font-bold">Add Revision Notes</h1>
        <p className="text-muted-foreground text-sm mt-0.5">Create HTML revision notes for a chapter.</p>
      </div>
      <RevisionNotesForm grades={grades} packages={packages} />
    </div>
  )
}
